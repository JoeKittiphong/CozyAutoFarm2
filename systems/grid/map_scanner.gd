...
static func apply_layers_to_grid(ground_layer: TileMapLayer, water_layer: TileMapLayer, obstacles_layer: TileMapLayer) -> void:
	...
	GridManager.reset_map_cells(ground_cells, water_cells, blocked_cells)
